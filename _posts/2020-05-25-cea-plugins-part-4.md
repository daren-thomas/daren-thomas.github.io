...
Now that you have an overview of the CEA plugin template, let's dive into some of the files responsible for adding  
...
Python uses this file to mark the folder `cea_plugin_template` as a package. Normally, this file is empty.
